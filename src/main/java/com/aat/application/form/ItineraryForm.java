...
public class ItineraryForm extends FormLayout {
	...
	public ItineraryForm(List<ZJTResourceType> resourceTypes, List<ZJTElement> tripElements) 
	{
...
//		binder.forField(resourceType).asRequired();
	...
	public static class SaveEvent extends ProductFormEvent {
	  SaveEvent(ItineraryForm source, ZJTProduct product) {
	    super(source, product);
	  }
	}

	public static class DeleteEvent extends ProductFormEvent {
	  DeleteEvent(ItineraryForm source, ZJTProduct product) {
	    super(source, product);
	  }
	...
	public static class CloseEvent extends ProductFormEvent {
	  CloseEvent(ItineraryForm source) {
	    super(source, null);
	  }
	}
